...
<Cards>
  ...
  <Card icon={svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-6 h-6">
  <circle cx="12" cy="12" r="9" stroke-linecap="round" stroke-linejoin="round"/>
  <text x="50%" y="53%" text-anchor="middle" dominant-baseline="middle" font-size="10" fill="none">1</text>
</svg>} title="Steps" href="/docs/docs-theme/built-ins/steps">
  </Card>
</Cards>
